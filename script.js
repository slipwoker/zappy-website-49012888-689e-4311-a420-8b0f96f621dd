    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Erranzz uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '49012888-689e-4311-a420-8b0f96f621dd',
                    name: data.name || '',
                    email: data.email || '',
